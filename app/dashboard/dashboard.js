...
export default function ChurchDashboard() {
    ...
    const menuItems = [
        ...
        { id: 'goLive', label: 'Go Live', icon: Church, href: '/dashboard/live-program' },
    ...
    const handleNavigation = (item) => {
        if (item.href) {
            ...
            // Set active section for internal navigation
            ...
            <div className="flex">
                ...
                <div className="flex-1 p-6 lg:p-8">
                    ...
                    {activeSection === 'goLive' && (
                        <div className="text-center py-20">
                            <Church className="w-16 h-16 text-amber-600 mx-auto mb-4" />
                            <h2 className="text-2xl font-bold text-gray-900 mb-2">Live Streaming</h2>
                            <p className="text-gray-600">Manage live streaming settings and configurations</p>
                            <button className='bg-orange-600 rounded-lg px-10 py-2 mt-5 text-white'> <Link href="/dashboard/live-program">Go live</Link></button>
                        </div>
                    )}
