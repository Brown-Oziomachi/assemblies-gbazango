        ...
        <div className="min-h-screen bg-white">
            ...
            <header className="bg-linear-to-r from-pink-400 to-red-400 text-white py-5 px-6 text-center shadow-lg">
                ...
                <img
                    src="/logo.png"
                    alt="AG Church"
                    className="w-50 h-90 mx-auto mb-0"
                /> 
                </div>
                <h1 className="text-5xl font-bold mb-3 -mt-15 drop-shadow-lg">🌟 Children's Department 🌟</h1>
            ...
            <footer className="bg-black bg-opacity-20 text-white text-center py-6 mt-12">
                <p>&copy; 2025 Assemblies of God Church, Gbazango | Raising Godly Children for His Glory</p>
            </footer>
            <Footer />
        </div>
    );
