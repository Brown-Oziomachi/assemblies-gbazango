                                ...
                                {upcomingEvents.map((event) => (
                                    <div key={event.id} className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition">
                                        <div className="flex gap-6 flex-wrap">
                                            <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white w-20 h-20 rounded-lg flex flex-col items-center justify-center flex-shrink-0">
                        ...
                        <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} onClick={(e) => e.stopPropagation()} className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto my-8">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                ...
                                <div className="flex gap-4 pt-4 border-t">
                                    ...
                                    <button type="submit" className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold rounded-lg hover:shadow-lg transition flex items-center justify-center gap-2">
                                        <FaCheckCircle />
                                        Submit Application
                                    </button>
                                </div>
